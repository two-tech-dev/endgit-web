...
function FAQItem({ item }: { item: { q: string; a: string } }) {
  ...
  return (
    <div className="card" style={{
      ...
      >
        <span style={{ fontWeight: 600, fontSize: "0.9375rem", color: "var(--text-primary)", lineHeight: 1.4 }}>
          {item.q}
        </span>
        <ChevronDown
          size={18}
...
export default function FAQPage() {
  return (
    <div className="container" style={{ padding: "var(--space-10) 0 var(--space-16)", maxWidth: "780px" }}>
      {/* Header */}
      <div style={{ textAlign: "center", marginBottom: "var(--space-10)" }}>
        ...
        <h1 className="heading-1" style={{ marginBottom: "var(--space-2)" }}>Frequently Asked Questions</h1>
      ...
      <div style={{
        ...
        textAlign: "center", background: "rgba(6,182,212,0.04)",
        borderRadius: "var(--radius-lg)", border: "1px solid rgba(6,182,212,0.12)"
      }}>
