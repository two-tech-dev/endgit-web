        ...
        <CardContent className="p-6 sm:p-8">
          ...
          <div className="flex flex-col gap-6 text-muted-foreground leading-relaxed">
            <p className="text-sm leading-relaxed text-muted-foreground">
              This page sets out the terms on which you may access and make use
              of our website EndGit (the &quot;Site&quot;), whether as a guest
              or a registered user. Please read these terms of use carefully
              before you start to use the site. By using the Site, you indicate
              that you accept these terms of use and that you agree to abide by
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              EndGit is a site operated by 2Tech Studio (
              <a
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              the Site without notice. We will not be liable if for any reason
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              account access at any time, if in our opinion you have failed to
              comply with any of the provisions of these terms of use.
            </p>
            <p className="text-sm leading-relaxed text-muted-foreground">
              You must keep your GitHub account credentials confidential at all
              times. Any breach of these terms of use by anyone to whom you
              disclose your credentials will be treated as if the breach had
              been committed by you, and will not relieve you of your
              obligations under these terms of use.
            </p>
            <p className="text-sm leading-relaxed text-muted-foreground">
              You are responsible for making all arrangements necessary for you
              to have access to the Site. You are also responsible for ensuring
              that all persons who access the Site through your internet
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              You must not use any part of the materials on the Site for
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Commentary and other materials posted on the Site are not
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              We aim to update the Site regularly, and may change the content
              at any time. If the need arises, we may suspend access to the
              Site, or close it indefinitely. Any of the material on the Site
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              The material displayed on the Site is provided without any
            ...
            <ul className="flex list-disc flex-col gap-2 pl-6 text-sm text-muted-foreground">
              <li>
              ...
              <li>
                ...
                or damage incurred by any user in connection with the Site or
                ...
                liability for:
                <ul className="mt-2 flex list-disc flex-col gap-1 pl-6 text-sm text-muted-foreground">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              This does not affect our liability for fraudulent
            ...
            <ul className="flex list-disc flex-col gap-2 pl-6 text-sm text-muted-foreground">
              ...
              <li>
                to send, upload, download, share, publish, use or reuse any
                material which does not comply with our content standards
                below, and local, national or international law;
              </li>
              <li>
            ...
            <ul className="flex list-disc flex-col gap-2 pl-6 text-sm text-muted-foreground">
              <li>
                not to reproduce, duplicate, copy or resell any part of the
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Where we do provide any Interactive Services, we will provide
              clear information to you about the kind of service offered, if it
              is moderated and what form of moderation is used (including
              whether it is human or technical).
            </p>
            <p className="text-sm leading-relaxed text-muted-foreground">
              We will do our best to assess any possible risks for users (and
              in particular, for children) from third parties when they use any
              Interactive Services provided on the Site, and we will decide in
              ...
              oversee, monitor or moderate any Interactive Services we provide
              on the Site, and we expressly exclude our liability for any loss
              or damage arising from the use of any Interactive Services by a
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              who permit their children to use the Interactive Services that
              ...
              are using any Interactive Services should be made aware of the
              potential risks to them.
            </p>
            <p className="text-sm leading-relaxed text-muted-foreground">
              Where we do moderate any Interactive Services, we will normally
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              contribute to the Site (&quot;Contributions&quot;), and to any
            ...
            <ul className="flex list-disc flex-col gap-2 pl-6 text-sm text-muted-foreground">
              ...
              <li>
                comply with applicable laws in the US and any country from
                which the Contributions are posted.
              </li>
            </ul>
            <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              breach of these terms of use through your use of the Site. When
              a breach of these terms of use has occurred, we may take such
              action as we deem appropriate.
            </p>
            <p className="text-sm leading-relaxed text-muted-foreground">
              Failure to comply with these terms of use constitutes a material
              breach of these terms of use and may result in our taking all or
            ...
            <ul className="flex list-disc flex-col gap-2 pl-6 text-sm text-muted-foreground">
              ...
              <li>
                ...
                material uploaded by you to the Site;
              </li>
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              policy. By using the Site, you consent to such processing and
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              unauthorised access to the Site, the server on which the Site is
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              The Site must not be framed on any other site, nor may you
              ...
              notice. If you wish to make any use of material on the Site
              other than that set out above, please contact EndGit.
            </p>
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Where the Site contains links to other sites and resources
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              The US courts will have non-exclusive jurisdiction over any claim
              arising from, or related to, a visit to the Site (although we
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              by and construed in accordance with the law of the US.
            </p>
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              be superseded by provisions or notices published elsewhere on the
              Site.
            </p>
