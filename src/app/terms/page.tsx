    ...
    <div className="container py-12 lg:py-20">
      ...
      <div className="grid gap-6 text-text-secondary leading-relaxed">
        <p>
          ...
          registered user. Please read these terms of use carefully before you
          start to use the site. By using the Site, you indicate that you accept
          these terms of use and that you agree to abide by them. If you do not
        ...
        <p>
          ...
          without notice. We will not be liable if for any reason the Site is
          unavailable at any time or for any period.
        </p>
        <p>
          From time to time, we may restrict access to some parts of the Site,
          or our entire site, to users who have registered with us or not.
        </p>
        <p>
          We have the right to disable any user identification code or account
          access at any time, if in our opinion you have failed to comply with
          any of the provisions of these terms of use.
        </p>
        <p>
          You must keep your GitHub account credentials confidential at all
          times. Any breach of these terms of use by anyone to whom you disclose
          your credentials will be treated as if the breach had been committed
          by you, and will not relieve you of your obligations under these terms
          of use.
        </p>
        <p>
          You are responsible for making all arrangements necessary for you to
          have access to the Site. You are also responsible for ensuring that
        ...
        <p>
          You must not use any part of the materials on the Site for commercial
        ...
        <p>
          We aim to update the Site regularly, and may change the content at any
          time. If the need arises, we may suspend access to the Site, or close
          it indefinitely. Any of the material on the Site may be out of date at
        ...
        <ul className="list-disc pl-6 grid gap-2">
          ...
          <li>
            ...
            damage incurred by any user in connection with the Site or in
        ...
        <p>
          This does not affect our liability for fraudulent misrepresentation or
        ...
        <ul className="list-disc pl-6 grid gap-2">
          ...
          <li>
            to send, upload, download, share, publish, use or reuse any material
            which does not comply with our content standards below, and local,
        ...
        <p>
          Where we do provide any Interactive Services, we will provide clear
        ...
        <p>
          ...
          Interactive Services provided on the Site, and we will decide in each
          ...
          or moderate any Interactive Services we provide on the Site, and we
          expressly exclude our liability for any loss or damage arising from
          the use of any Interactive Services by a user in contravention of our
        ...
        <p>
          ...
          their children to use the Interactive Services that it is important
          ...
          Services should be made aware of the potential risks to them.
        </p>
        <p>
        ...
        <ul className="list-disc pl-6 grid gap-2">
          ...
          <li>
            comply with applicable laws in the US and any country from which the
        ...
        <p>
          ...
          of these terms of use through your use of the Site. When a breach of
          these terms of use has occurred, we may take such action as we deem
          appropriate.
        </p>
        <p>
        ...
        <p>
          ...
          these terms of use. The responses described in these Terms of use are
        ...
        <p>
          By breaching this provision, you would commit a criminal offence. We
        ...
        <p>
          The Site must not be framed on any other site, nor may you create a
          link to any part of the Site other than the home page. We reserve the
          right to withdraw linking permission without notice. If you wish to
          make any use of material on the Site other than that set out above,
        ...
        <p>
          ...
          arising from, or related to, a visit to the Site (although we retain
