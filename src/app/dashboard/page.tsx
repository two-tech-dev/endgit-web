...
export default async function DashboardPage() {
    ...
    const githubTokenExpired =
        statusRes.data?.data?.githubTokenExpired || false;
    const installUrl =
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    >
                        For security reasons, your connection to GitHub has
                        expired. Please re-authenticate to sync your App
                        installation status and continue using the Developer
                        Dashboard.
                    </p>
                    <a
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    >
                        To get started with the Developer Dashboard, you need to
                        install the EndGit GitHub App on your repositories. The
                        app will automatically detect your Bedrock plugins,
                        build them using our CI/CD pipeline, and publish them to
                        the marketplace.
                    </p>
                    <a
                        href={installUrl}
