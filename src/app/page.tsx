    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-16)", paddingBottom: "var(--space-16)" }}>
      ...
      <section style={{
        ...
        <div className="container" style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "var(--space-6)" }}>
          ...
          <h1 className="heading-1" style={{ maxWidth: "800px", lineHeight: 1.1, letterSpacing: "-0.02em" }}>
            The standard registry for <span style={{ color: "var(--accent-cyan)" }}>Endstone</span> plugins
          </h1>

          <p className="text-muted" style={{ fontSize: "clamp(1rem, 2.5vw, 1.25rem)", maxWidth: "600px", lineHeight: 1.6 }}>
          ...
          <div style={{ display: "flex", gap: "var(--space-4)", marginTop: "var(--space-4)", flexWrap: "wrap", justifyContent: "center" }}>
            ...
            <div style={{
              ...
              fontSize: "clamp(0.8125rem, 2vw, 0.9375rem)", boxShadow: "var(--shadow-sm)"
            }}>
