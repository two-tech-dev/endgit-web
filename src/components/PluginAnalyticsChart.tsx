...
export default function PluginAnalyticsChart({ slug }: { slug: string }) {
 ...
 if (loading) {
 return (
 <div className="card p-4 lg:p-6 h-[280px] grid place-items-center">
 ...
 <BarChart3 size={18} className="text-[#1890ff]" /> Downloads (Last 30
 Days)
 </h3>
 <span className="text-xl font-bold text-[#1890ff] ">
